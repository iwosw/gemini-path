...
1. Скачайте **[GeminiPath-Setup-0.2.0.exe](https://github.com/iwosw/gemini-path/releases/latest/download/GeminiPath-Setup-0.2.0.exe)** из [Releases](https://github.com/iwosw/gemini-path/releases/latest).
